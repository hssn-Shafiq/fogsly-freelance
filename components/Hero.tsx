    ...
    <section className="relative overflow-hidden pt-4">
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 pt-0 md:pt-0 pb-4 relative z-10 max-w-[100%] sm:max-w-[100%]">
        <div className="max-w-7xl bg-[--color-bg-hero] rounded-3xl shadow-2xl mt-0 mx-auto py-8 sm:py-10 text-center md:px-8 px-5">
          ...
          {/* Main Heading */}
          <motion.h1
            className="text-3xl sm:text-5xl md:text-7xl font-bold mb-4 sm:mb-6 text-[--color-text-hero]"
            {...{
          ...
          >
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-[--color-primary] to-[--color-accent]">
              Freelance.
            </span>{" "}
            On-Demand.
          ...
          {/* Sub Heading */}
          <motion.h2
            className="font-kalam text-2xl sm:text-4xl md:text-6xl my-3 sm:my-4"
            style={{ color: '#C85738' }}
            {...{
          ...
          {/* Paragraph */}
          <motion.p
            className="text-base sm:text-lg md:text-xl text-[--color-text-hero] max-w-3xl mx-auto mb-8 sm:mb-10"
            {...{
              initial: { opacity: 0, y: 20 },
              animate: { opacity: 1, y: 0 },
          ...
          >
            FOGSLY is the premier platform for professionals. Hire expert freelancers for digital
            projects or find reliable taskers for local, physical jobs. No distractions, just results.
          </motion.p>
